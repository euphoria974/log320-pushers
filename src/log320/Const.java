...
public final class Const {
    // Heuristiques
    public static final long MAX_TIME_MILLIS = 4910;
    ...
    public static final int PUSHER_WEIGHT = 410;
    public static final int PAWN_WEIGHT = 203;
    public static final int BACKED_PUSHER_WEIGHT = 115;
    public static final int DISTANCE_TO_WIN_WEIGHT = 67;
    public static final int MOBILITY_WEIGHT = 41;
    public static final int CLEAR_PATH_WEIGHT = 153;
    public static final int EXPOSED_PUSHER_WEIGHT = -500;
